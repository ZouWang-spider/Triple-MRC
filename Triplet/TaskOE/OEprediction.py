...
#加载训练好的模型参数
model.load_state_dict(torch.load('/Triplet/SaveModel/OEmodel.pth', map_location='cpu'))
...
with torch.no_grad():  # 关闭梯度计算
    ...
    if start_index > end_index:
        ...
        # 提取 opinion term
        opinion_term = " ".join(tokens[start_index:end_index + 1])

    print("Opinion Terms:", opinion_term)